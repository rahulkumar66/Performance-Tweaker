...
public class Alarm extends StatElement implements Comparable<Alarm>, Serializable {
  ...
  @SerializedName("package_name") String m_strPackageName;

  /** The number od wakeups */
  @SerializedName("wakeups") long m_nWakeups;

  /** The duration of the sample */
  @SerializedName("time_runing_ms") long m_timeRunning;

  /** The total count */
  @SerializedName("total_count") long m_nTotalCount;

  /** The details */
  @SerializedName("items") ArrayList<AlarmItem> m_items;
   ...
   * The default cctor
   */
  public Alarm(String strName, long lWakeups, long lCount, long timeRunning,
