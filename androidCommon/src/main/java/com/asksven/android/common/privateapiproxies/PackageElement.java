 ...
 * @author sven
 */
public class PackageElement extends StatElement
    implements Comparable<PackageElement>, Serializable {
  /**
   * the tag for logging
   */
   ...
   */
  @SerializedName("package_name") private String m_packageName;
   ...
   * the duration in ms
   */
  @SerializedName("duration_ms") private long m_duration;
   ...
   */
  @SerializedName("wakeups") private long m_wakeups;

  /**
   * the total data transfer
   */
  @SerializedName("rxtx") private long m_rxtx;
   ...
   */
  public PackageElement(String packageName, String name, int uid, long duration, long time,
      int count, long wakeups, long rxtx) {
  ...
  public PackageElement clone() {
    PackageElement clone =
        new PackageElement(m_packageName, m_name, getuid(), m_duration, getTotal(), m_count,
            m_wakeups, m_rxtx);
  ...
  public String getData(long totalTime) {
    return this.formatDuration(getDuration()) + " Wakeups:" + m_wakeups + " Data:" + formatVolume(
        m_rxtx) + " " + this.formatRatio(getDuration(), totalTime);
  }
