...
public class HistoryItemKitKat extends HistoryItem implements Serializable, Parcelable {
  ...
  public static final int MOST_INTERESTING_STATES = STATE_BATTERY_PLUGGED_FLAG
  ...
  public static final BitDescription[] HISTORY_STATE_DESCRIPTIONS = new BitDescription[] {
      ...
      new BitDescription(STATE_BRIGHTNESS_MASK, HistoryItem.STATE_BRIGHTNESS_SHIFT, "brightness",
          SCREEN_BRIGHTNESS_NAMES),
      new BitDescription(STATE_SIGNAL_STRENGTH_MASK, HistoryItem.STATE_SIGNAL_STRENGTH_SHIFT,
          "signal_strength", SIGNAL_STRENGTH_NAMES),
      new BitDescription(STATE_PHONE_STATE_MASK, HistoryItem.STATE_PHONE_STATE_SHIFT, "phone_state",
          new String[] { "in", "out", "emergency", "off" }),
      new BitDescription(STATE_DATA_CONNECTION_MASK, STATE_DATA_CONNECTION_SHIFT, "data_conn",
  ...
  public HistoryItemKitKat(Long time, Byte cmd, Byte batteryLevel, Byte batteryStatusValue,
      Byte batteryHealthValue, Byte batteryPlugTypeValue, String batteryTemperatureValue,
      String batteryVoltageValue, Integer statesValue) {
    super(time, cmd, batteryLevel, batteryStatusValue, batteryHealthValue, batteryPlugTypeValue,
