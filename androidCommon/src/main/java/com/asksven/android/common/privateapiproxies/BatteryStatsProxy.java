...
public class BatteryStatsProxy {
  ...
  @SuppressWarnings("rawtypes") private Class m_ClassDefinition = null;
  /*
  ...
  private BatteryStatsProxy(Context context) {
    ...
    try {
      ...
      @SuppressWarnings("rawtypes") Class serviceManagerClass =
          cl.loadClass("android.os.ServiceManager");

      // parameter types
      @SuppressWarnings("rawtypes") Class[] paramTypesGetService = new Class[1];
      paramTypesGetService[0] = String.class;

      @SuppressWarnings("unchecked") Method methodGetService =
          serviceManagerClass.getMethod("getService", paramTypesGetService);
      ...
      IBinder serviceBinder =
          (IBinder) methodGetService.invoke(serviceManagerClass, paramsGetService);
      ...
      @SuppressWarnings("rawtypes") Class iBatteryStatsStub =
          cl.loadClass("com.android.internal.app.IBatteryStats$Stub");

      //Parameters Types
      @SuppressWarnings("rawtypes") Class[] paramTypesAsInterface = new Class[1];
      paramTypesAsInterface[0] = IBinder.class;

      @SuppressWarnings("unchecked") Method methodAsInterface =
          iBatteryStatsStub.getMethod("asInterface", paramTypesAsInterface);
      ...
      @SuppressWarnings("rawtypes") Class iBatteryStats =
          cl.loadClass("com.android.internal.app.IBatteryStats");

      @SuppressWarnings("unchecked") Method methodGetStatistics =
          iBatteryStats.getMethod("getStatistics");
      ...
      @SuppressWarnings("rawtypes") Class batteryStatsImpl =
          cl.loadClass("com.android.internal.os.BatteryStatsImpl");
      ...
      @SuppressWarnings("rawtypes") Parcelable.Creator batteryStatsImpl_CREATOR =
          (Parcelable.Creator) creatorField.get(batteryStatsImpl);

      m_Instance = batteryStatsImpl_CREATOR.createFromParcel(parcel);
    } catch (Exception e) {
      if (e instanceof InvocationTargetException && e.getCause() != null) {
        Log.e(TAG,
            "An exception occured in BatteryStatsProxy(). Message: " + e.getCause().getMessage());
      } else {
  ...
  public Long computeBatteryRealtime(long curTime, int iStatsType)
    ...
    try {
      ...
      @SuppressWarnings("unchecked") Method method =
          m_ClassDefinition.getMethod("computeBatteryRealtime", paramTypes);
  ...
  public Long getBatteryRealtime(long curTime) throws BatteryInfoUnavailableException {
    ...
    try {
      ...
      @SuppressWarnings("unchecked") Method method =
          m_ClassDefinition.getMethod("getBatteryRealtime", paramTypes);
  ...
  public Long computeBatteryUptime(long curTime, int iStatsType)
    ...
    try {
      ...
      @SuppressWarnings("unchecked") Method method =
          m_ClassDefinition.getMethod("computeBatteryUptime", paramTypes);
  ...
  public Long getScreenOnTime(long batteryRealtime, int iStatsType)
    ...
    try {
      ...
      @SuppressWarnings("unchecked") Method method =
          m_ClassDefinition.getMethod("getScreenOnTime", paramTypes);
  ...
  public boolean getIsOnBattery() throws BatteryInfoUnavailableException {
    ...
    try {
      ...
      @SuppressWarnings("unchecked") Method method =
          m_ClassDefinition.getMethod("getIsOnBattery", paramTypes);
  ...
  public Long getPhoneOnTime(long batteryRealtime, int iStatsType)
    ...
    try {
      ...
      @SuppressWarnings("unchecked") Method method =
          m_ClassDefinition.getMethod("getPhoneOnTime", paramTypes);
  ...
  public Long getWifiOnTime(long batteryRealtime, int iStatsType)
    ...
    try {
      ...
      @SuppressWarnings("unchecked") Method method =
          m_ClassDefinition.getMethod("getWifiOnTime", paramTypes);
      ...
      if (CommonLogSettings.DEBUG) {
        Log.i(TAG,
            "getWifiOnTime with params " + params[0] + " and " + params[1] + " returned " + ret);
      }
    } catch (IllegalArgumentException e) {
      throw e;
    } catch (Exception e) {
  ...
  public Long getGlobalWifiRunningTime(long batteryRealtime, int iStatsType)
    ...
    try {
      ...
      @SuppressWarnings("unchecked") Method method =
          m_ClassDefinition.getMethod("getGlobalWifiRunningTime", paramTypes);
      ...
      if (CommonLogSettings.DEBUG) {
        Log.i(TAG, "getGlobalWifiRunningTime with params "
            + params[0]
            + " and "
            + params[1]
            + " returned "
    ...
    if (m_uidStats != null) {
      try {
        ...
        @SuppressWarnings("rawtypes") Class iBatteryStatsUid =
            cl.loadClass("com.android.internal.os.BatteryStatsImpl$Uid");
        ...
        for (int iu = 0; iu < NU; iu++) {
          ...
          @SuppressWarnings("unchecked") Method method =
              iBatteryStatsUid.getMethod("getWifiRunningTime", paramTypes);
          ...
          if (CommonLogSettings.DEBUG) {
            Log.i(TAG, "getWifiRunningTime with params "
                + params[0]
                + " and "
                + params[1]
                + " returned "
    ...
    if (m_uidStats != null) {
      try {
        ...
        for (int iu = 0; iu < NU; iu++) {
          ...
          @SuppressWarnings("unchecked") Method method =
              iBatteryStatsUid.getMethod("getFullWifiLockTime", paramTypes);
    ...
    if (m_uidStats != null) {
      try {
        ...
        for (int iu = 0; iu < NU; iu++) {
          ...
          @SuppressWarnings("unchecked") Method method =
              iBatteryStatsUid.getMethod("getScanWifiLockTime", paramTypes);
    ...
    if (m_uidStats != null) {
      try {
        ...
        for (int iu = 0; iu < NU; iu++) {
          ...
          @SuppressWarnings("unchecked") Method method =
              iBatteryStatsUid.getMethod("getWifiMulticastTime", paramTypes);
  ...
  /**
   * Returns the time in microseconds the phone has been running with the given data connection
   * type.
   *
   * @param batteryRealtime the battery realtime in microseconds (@see computeBatteryRealtime).
   * @param iStatsType one of STATS_TOTAL, STATS_LAST, or STATS_CURRENT.
  ...
  public Long getPhoneDataConnectionTime(int dataType, long batteryRealtime, int iStatsType)
    ...
    try {
      ...
      @SuppressWarnings("unchecked") Method method =
          m_ClassDefinition.getMethod("getPhoneDataConnectionTime", paramTypes);
   ...
   */
  public Long getScreenBrightnessTime(int brightness, long batteryRealtime, int iStatsType)
      throws BatteryInfoUnavailableException {
    Long ret = new Long(0);
    ...
    try {
      ...
      @SuppressWarnings("unchecked") Method method =
          m_ClassDefinition.getMethod("getScreenBrightnessTime", paramTypes);
      ...
      ret = (Long) method.invoke(m_Instance, params);
      if (CommonLogSettings.DEBUG) {
        Log.i(TAG, "getScreenBrightnessTime with params "
            + params[0]
            + ", "
            + params[1]
            + "and "
    ...
    if (m_uidStats != null) {
      try {
        ...
        for (int iu = 0; iu < NU; iu++) {
          ...
          @SuppressWarnings("unchecked") Method method =
              iBatteryStatsUid.getMethod("getAudioTurnedOnTime", paramTypes);
    ...
    if (m_uidStats != null) {
      try {
        ...
        for (int iu = 0; iu < NU; iu++) {
          ...
          @SuppressWarnings("unchecked") Method method =
              iBatteryStatsUid.getMethod("getVideoTurnedTime", paramTypes);
  ...
  public Long getBluetoothOnTime(long batteryRealtime, int iStatsType)
    ...
    try {
      ...
      @SuppressWarnings("unchecked") Method method =
          m_ClassDefinition.getMethod("getBluetoothOnTime", paramTypes);
  ...
  public int getDischargeCurrentLevel() throws BatteryInfoUnavailableException {
    ...
    try {
      @SuppressWarnings("unchecked") Method method =
          m_ClassDefinition.getMethod("getDischargeCurrentLevel");
  ...
  public boolean startIteratingHistoryLocked() throws BatteryInfoUnavailableException {
    ...
    try {
      @SuppressWarnings("unchecked") Method method =
          m_ClassDefinition.getMethod("startIteratingHistoryLocked");

      ret = (Boolean) method.invoke(m_Instance);
    } catch (IllegalArgumentException e) {
      Log.e(TAG, "An exception occured in startIteratingHistoryLocked(). Message: "
          + e.getMessage()
          + ", cause: "
  ...
  public boolean finishIteratingHistoryLocked() throws BatteryInfoUnavailableException {
    ...
    try {
      @SuppressWarnings("unchecked") Method method =
          m_ClassDefinition.getMethod("finishIteratingHistoryLocked");

      ret = (Boolean) method.invoke(m_Instance);
    } catch (IllegalArgumentException e) {
      Log.e(TAG, "An exception occured in finishIteratingHistoryLocked(). Message: "
          + e.getMessage()
          + ", cause: "
          + e.getCause().getMessage());
      throw e;
   ...
   */
  @SuppressWarnings("unchecked") private void collectUidStats() {
    try {
   ...
   * @throws Exception
   */
  @SuppressWarnings("unchecked") public ArrayList<StatElement> getWakelockStats(Context context,
      int iWakeType, int iStatType, int iWlPctRef) throws Exception {
    // type checks
    boolean validTypes =
        (BatteryStatsTypes.assertValidWakeType(iWakeType) && BatteryStatsTypes.assertValidStatType(
            iStatType) && BatteryStatsTypes.assertValidWakelockPctRef(iWlPctRef));
    if (!validTypes) {
    ...
    this.collectUidStats();
    if (m_uidStats != null) {
      long uSecBatteryTime =
          this.computeBatteryRealtime(SystemClock.elapsedRealtime() * 1000, iStatType);
      long uSecAwakeTime =
          this.computeBatteryUptime(SystemClock.elapsedRealtime() * 1000, iStatType);
      ...
      try {
        ...
        for (int iu = 0; iu < NU; iu++) {
          ...
          Map<String, ? extends Object> wakelockStats =
              (Map<String, ? extends Object>) methodGetWakelockStats.invoke(myUid);
          ...
          for (Map.Entry<String, ? extends Object> wakelockEntry : wakelockStats.entrySet()) {
            ...
            @SuppressWarnings("rawtypes") Class batteryStatsUidWakelock =
                cl.loadClass("com.android.internal.os.BatteryStatsImpl$Uid$Wakelock");

            //Parameters Types
            @SuppressWarnings("rawtypes") Class[] paramTypesGetWakeTime = new Class[1];
            paramTypesGetWakeTime[0] = int.class;

            Method methodGetWakeTime =
                batteryStatsUidWakelock.getMethod("getWakeTime", paramTypesGetWakeTime);
            ...
            if (wakeTimer != null) {
              @SuppressWarnings("rawtypes") Class iBatteryStatsTimer =
                  cl.loadClass("com.android.internal.os.BatteryStatsImpl$Timer");

              //Parameters Types
              @SuppressWarnings("rawtypes") Class[] paramTypesGetTotalTimeLocked = new Class[2];
              paramTypesGetTotalTimeLocked[0] = long.class;
              paramTypesGetTotalTimeLocked[1] = int.class;

              Method methodGetTotalTimeLocked =
                  iBatteryStatsTimer.getMethod("getTotalTimeLocked", paramTypesGetTotalTimeLocked);
              ...
              Long wake =
                  (Long) methodGetTotalTimeLocked.invoke(wakeTimer, paramsGetTotalTimeLocked);
              //							Log.d(TAG, "Wakelocks inner: Process = " + wakelockEntry.getKey() + " wakelock [s] " + wake);
              wakelockTime += wake;

              //Parameters Types
              @SuppressWarnings("rawtypes") Class[] paramTypesGetCountLocked = new Class[1];
              paramTypesGetCountLocked[0] = int.class;

              Method methodGetCountLocked =
                  iBatteryStatsTimer.getMethod("getCountLocked", paramTypesGetCountLocked);
              ...
              Integer count =
                  (Integer) methodGetCountLocked.invoke(wakeTimer, paramsGetCountLocked);
            ...
            if (Build.VERSION.SDK_INT >= 20) {
              myWl = new Wakelock(iWakeType, wakelockEntry.getKey(), wakelockTime, uSec,
                  wakelockCount);
            } else {
              myWl = new Wakelock(iWakeType, wakelockEntry.getKey(), wakelockTime, uSec / 1000,
                  wakelockCount);
            }
   ...
   * @throws Exception
   */
  @SuppressWarnings("unchecked") public ArrayList<StatElement> getKernelWakelockStats(
      Context context, int iStatType, boolean bAlternate) throws Exception {
    // type checks
    ...
    Log.d(TAG, "getWakelockStats was called with params " + "[iStatType] = " + iStatType);
    ...
    try {
      ...
      Class classSamplingTimer =
          cl.loadClass("com.android.internal.os.BatteryStatsImpl$SamplingTimer");

      Field currentReportedCount = classSamplingTimer.getDeclaredField("mCurrentReportedCount");
      Field currentReportedTotalTime =
          classSamplingTimer.getDeclaredField("mCurrentReportedTotalTime");
      Field unpluggedReportedCount = classSamplingTimer.getDeclaredField("mUnpluggedReportedCount");
      Field unpluggedReportedTotalTime =
          classSamplingTimer.getDeclaredField("mUnpluggedReportedTotalTime");
      ...
      Map<String, ? extends Object> kernelWakelockStats =
          (Map<String, ? extends Object>) methodGetKernelWakelockStats.invoke(m_Instance);
      ...
      for (Map.Entry<String, ? extends Object> wakelockEntry : kernelWakelockStats.entrySet()) {
        ...
        Method methodGetTotalTimeLocked =
            classSamplingTimer.getMethod("getTotalTimeLocked", paramTypesGetTotalTimeLocked);
        ...
        Method methodGetCountLocked =
            classSamplingTimer.getMethod("getCountLocked", paramTypesGetCountLocked);
        ...
        //				else
        //				{
        NativeKernelWakelock myWl =
            new NativeKernelWakelock(wakelockEntry.getKey(), "*api*", unpluggedReportedCountVal, 0,
                0, 0L, unpluggedReportedTotalTimeVal / 1000, unpluggedReportedTotalTimeVal / 1000,
                0L, 0L, uSecBatteryTime / 1000);
        myStats.add(myWl);
        //				}
      }
    } catch (Exception e) {
      Log.e(TAG, "An exception occured in getKernelWakelockStats(). Message: "
          + e.getMessage()
          + ", cause: "
          + e.getCause().getMessage());
      throw e;
   ...
   * @throws Exception
   */
  @SuppressWarnings("unchecked") public ArrayList<StatElement> getProcessStats(Context context,
    ...
    if (m_uidStats != null) {
      try {
        ...
        for (int iu = 0; iu < NU; iu++) {
          ...
          Map<String, ? extends Object> processStats =
              (Map<String, ? extends Object>) methodGetProcessStats.invoke(myUid);
          ...
          if (processStats.size() > 0) {
            for (Map.Entry<String, ? extends Object> ent : processStats.entrySet()) {
              ...
              @SuppressWarnings("rawtypes") Class batteryStatsUidProc =
                  cl.loadClass("com.android.internal.os.BatteryStatsImpl$Uid$Proc");

              //Parameters Types
              @SuppressWarnings("rawtypes") Class[] paramTypesGetXxxTime = new Class[1];
              paramTypesGetXxxTime[0] = int.class;

              Method methodGetUserTime =
                  batteryStatsUidProc.getMethod("getUserTime", paramTypesGetXxxTime);
              Method methodGetSystemTime =
                  batteryStatsUidProc.getMethod("getSystemTime", paramTypesGetXxxTime);
              Method methodGetStarts =
                  batteryStatsUidProc.getMethod("getStarts", paramTypesGetXxxTime);
        ...
        Log.e(TAG, "An exception occured in getProcessStats(). Message: "
            + e.getMessage()
            + ", cause: "
            + e.getCause().getMessage());
        throw e;
   ...
   * @throws Exception
   */
  @SuppressWarnings("unchecked") public ArrayList<StatElement> getWakeupStats(Context context,
      int iStatType) throws Exception {
    // type checks
    boolean validTypes = BatteryStatsTypes.assertValidStatType(iStatType);
    if (!validTypes) {
    ...
    if (m_uidStats != null) {
      try {
        ...
        for (int iu = 0; iu < NU; iu++) {
          ...
          // Map of String, BatteryStats.Uid.Proc
          Map<String, ? extends Object> packageStats =
              (Map<String, ? extends Object>) methodGetPackageStats.invoke(myUid);
          ...
          if (packageStats.size() > 0) {
            for (Map.Entry<String, ? extends Object> ent : packageStats.entrySet()) {
              ...
              // Object is a BatteryStatsTypes.Uid.Proc
              Object ps = ent.getValue();
              @SuppressWarnings("rawtypes") Class batteryStatsUidPkg =
                  cl.loadClass("com.android.internal.os.BatteryStatsImpl$Uid$Pkg");

              //Parameters Types
              @SuppressWarnings("rawtypes") Class[] paramTypesGetWakeups = new Class[1];
              paramTypesGetWakeups[0] = int.class;

              Method methodGetWakeups =
                  batteryStatsUidPkg.getMethod("getWakeups", paramTypesGetWakeups);
        ...
        Log.e(TAG,
            "An exception occured in getWakeupStats(). Message: " + e.getMessage() + ", cause: " + e
                .getCause()
                .getMessage());
        throw e;
      }
   ...
   * @throws Exception
   */
  @SuppressWarnings("unchecked") public ArrayList<NetworkUsage> getNetworkUsageStats(
      Context context, int iStatType) throws Exception {
    // type checks
    boolean validTypes = BatteryStatsTypes.assertValidStatType(iStatType);
    if (!validTypes) {
      Log.e(TAG, "Invalid WakeType or StatType");
      ...
      try {
        ...
        for (int iu = 0; iu < NU; iu++) {
          ...
          if (Build.VERSION.SDK_INT < 19) {
            ...
            Method methodGetTcpBytesReceived =
                iBatteryStatsUid.getMethod("getTcpBytesReceived", paramTypesGetTcpBytesXxx);
            Method methodGetTcpBytesSent =
            ...
            @SuppressWarnings("rawtypes") Class[] paramTypesGetNetworkActivity =
                new Class[] { int.class, int.class };
            Method methodGetNetworkActivity =
                iBatteryStatsUid.getMethod("getNetworkActivityCount", paramTypesGetNetworkActivity);
            // Parameters for getting received bytes from mobile
            Object paramGetNetworkActivityCount[] = {
                NETWORK_MOBILE_RX_BYTES, iStatType
            };
            bytesReceived =
                (Long) methodGetNetworkActivity.invoke(myUid, paramGetNetworkActivityCount);
  ...
  @SuppressWarnings("unchecked") public ArrayList<HistoryItem> getHistory(Context context)
      throws Exception {
    ...
    try {
      ClassLoader cl = context.getClassLoader();
      @SuppressWarnings("rawtypes") Class classHistoryItem =
          cl.loadClass("android.os.BatteryStats$HistoryItem");
      ...
      @SuppressWarnings("unchecked") Method methodNext =
          m_ClassDefinition.getMethod("getNextHistoryLocked", paramTypes);
      ...
      Long statTimeRef = Long.valueOf(
          this.computeBatteryRealtime(SystemClock.elapsedRealtime() * 1000, statsType));
      statTimeRef = System.currentTimeMillis();

      if (CommonLogSettings.DEBUG) {
        Log.d(TAG,
            "Reference time (" + statTimeRef + ": " + DateUtils.format(DateUtils.DATE_FORMAT_NOW,
                statTimeRef));
      }
      ...
      if (this.startIteratingHistoryLocked()) {
        ...
        while (bNext) {
          ...
          if (cmdValue == updateCmd) {
            ...
            // retrieve all values
            @SuppressWarnings("rawtypes") Long timeValue = (Long) timeField.get(params[0]);
            ...
            if (!statTimeLast.equals(timeValue)) {
              ...
              String batteryTemperatureValue =
                  String.valueOf(batteryTemperatureField.get(params[0]));
              ...
              if ((Build.VERSION.SDK_INT == Build.VERSION_CODES.ICE_CREAM_SANDWICH)
                  || (Build.VERSION.SDK_INT == Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1)) {
                myItem =
                    new HistoryItemIcs(timeValue, cmdValue, batteryLevelValue, batteryStatusValue,
                        batteryHealthValue, batteryPlugTypeValue, batteryTemperatureValue,
                ...
                myItem = new HistoryItem(timeValue, cmdValue, batteryLevelValue, batteryStatusValue,
                    batteryHealthValue, batteryPlugTypeValue, batteryTemperatureValue,
                    batteryVoltageValue, statesValue);
              }
        ...
        if (CommonLogSettings.DEBUG) {
          ...
          Log.d(TAG,
              "Last sample (" + statTimeLast + ")" + DateUtils.format(DateUtils.DATE_FORMAT_NOW,
                  statTimeLast));

          Log.d(TAG, "Correcting all HistoryItem times by an offset of ("
              + offset
              + ")"
      ...
      Log.e(TAG, "An exception occured in getHistory(). Message: "
          + e.getMessage()
          + ", cause: "
          + e.getCause().getMessage());
      throw e;
  ...
  @SuppressWarnings("unchecked") public ArrayList<HistoryItem> dumpHistory(Context context)
      throws Exception {
    ...
    try {
        ...
        while (bNext) {
          ...
          if (true) //(cmdValue == updateCmd)
          {
            ...
            if (AndroidVersion.isLolipop()) {
              myItem =
                  new HistoryItemLolipop(timeValue, cmdValue, batteryLevelValue, batteryStatusValue,
                      batteryHealthValue, batteryPlugTypeValue, batteryTemperatureValue,
                      batteryVoltageValue, statesValue);
            }
            if (AndroidVersion.isKitKat()) {
              myItem =
                  new HistoryItemKitKat(timeValue, cmdValue, batteryLevelValue, batteryStatusValue,
                      batteryHealthValue, batteryPlugTypeValue, batteryTemperatureValue,
                      batteryVoltageValue, statesValue);
      ...
      Log.e(TAG, "An exception occured in dumpHistory(). Message: "
          + e.getMessage()
          + ", cause: "
          + e.getCause().getMessage());
      throw e;
    ...
    for (int i = 0; i < myStats.size(); i++) {
      ...
      Log.i(TAG,
          myItem.toString() + " " + myItem.printBitDescriptions(oldVal, myItem.m_statesValue));
