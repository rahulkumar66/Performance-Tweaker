 ...
 *         <string name="text_dialog_rate">If you enjoy using %s, please take a moment to rate it.
 *         Thanks for your support!</string>
 *
 *         To test it and to tweak the dialog appearence, you can call AppRater.showRateDialog(this,
 *         null)
 *         from your Activity.
 *
...
public class AppRater {
  ...
  public static void showRateDialog(final Context ctx, final SharedPreferences.Editor editor) {
    ...
    dialog.setTitle(
        ctx.getString(R.string.label_button_rate) + " " + ctx.getString(R.string.app_name));
    ...
    b1.setOnClickListener(new Button.OnClickListener() {
      public void onClick(View v) {
        ctx.startActivity(new Intent(Intent.ACTION_VIEW,
            Uri.parse("market://details?id=" + ctx.getString(R.string.app_pname))));
        if (editor != null) {
