...
public class Process extends StatElement implements Comparable<Process>, Serializable {
   ...
   */
  @SerializedName("system_time") private long m_systemTime;

  /**
   * the user time in ms
   */
  @SerializedName("user_time") private long m_userTime;

  /**
   * the number of starts
   */
  @SerializedName("starts") private int m_starts;
  ...
  public int compareTo(Process o) {
    ...
    return ((int) ((o.getSystemTime() + o.getUserTime()) - (this.getSystemTime()
        + this.getUserTime())));
  }
  ...
  public String getData(long totalTime) {
    return "Uid: "
        + this.getuid()
        + " Sys: "
        + this.formatDuration(getSystemTime())
        + " Us: "
        + this.formatDuration(getUserTime())
        + " Starts: "
        + String.valueOf(getStarts());
  }
  ...
  public static class ProcessTimeComparator implements Comparator<Process> {
    public int compare(Process a, Process b) {
      return ((int) ((b.getSystemTime() + b.getUserTime()) - (a.getSystemTime()
          + a.getUserTime())));
    }
  }
}
