...
public class NetworkUsage extends StatElement implements Comparable<NetworkUsage>, Serializable {
   ...
   */
  @SerializedName("bytes_received") @JsonProperty("bytes_received") private long m_bytesReceived =
      0;

  /**
   * tcpBytes sent by the program
   */
  @SerializedName("bytes_sent") @JsonProperty("bytes_sent") private long m_bytesSent = 0;

  /**
   * the interface
   */
  @SerializedName("iface") @JsonProperty("iface") private String m_iface = "";
    ...
    if (myList != null) {
      for (int i = 0; i < myList.size(); i++) {
        try {
          ...
          if ((this.getInterface().equals(myRef.getInterface())) && (this.getuid()
              == myRef.getuid())) {
   ...
   */
  @JsonProperty("iface") public String getInterface() {
    String ret = "";
   ...
   */
  @JsonProperty("bytes_received") public long getBytesReceived() {
   ...
   */
  @JsonProperty("bytes_sent") public long getBytesSent() {
    return m_bytesSent;
  }
   ...
   */
  @JsonIgnore public long getTotalBytes() {
  ...
  public int compareTo(NetworkUsage o) {
    ...
    return ((int) ((o.getBytesReceived() + o.getBytesSent()) - (this.getBytesReceived()
        + this.getBytesSent())));
  }
   ...
   */
  @JsonIgnore public String getData(long totalTime) {
   ...
   */
  @JsonIgnore public double[] getValues() {
  ...
  @JsonIgnore public String getPackageName() {
    if (m_uidInfo != null) {
