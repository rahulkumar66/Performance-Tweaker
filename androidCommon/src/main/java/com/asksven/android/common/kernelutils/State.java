...
public class State extends StatElement implements Comparable<State>, Serializable {
  ...
  @SerializedName("freq") public int m_freq = 0;

  @SerializedName("duration_ms") public long m_duration = 0;
  ...
  public String getVals() {
    ...
    return getName()
        + " "
        + this.formatDuration(m_duration)
        + " ("
        + m_duration / 1000
        + " s)"
        + " in "
        + this.formatDuration(getTotal())
        + " ("
        + getTotal() / 1000
        + " s)"
        + " Ratio: "
        + formatRatio(m_duration, getTotal());
  }
