...
import com.phantomLord.cpufrequtils.app.BuildConfig;
...
public interface Constants {
    ...
    */
    ...
    String scaling_min_freq = cpufreq_sys_dir
            + "scaling_min_freq";
    String cpuinfo_min_freq = cpufreq_sys_dir
            + "cpuinfo_min_freq";
    String scaling_max_freq = cpufreq_sys_dir
            + "scaling_max_freq";

    String cpuinfo_max_freq = cpufreq_sys_dir
            + "cpuinfo_max_freq";
    String scaling_cur_freq = cpufreq_sys_dir
            + "scaling_cur_freq";
    String cpuinfo_cur_freq = cpufreq_sys_dir
            + "cpuinfo_cur_freq";
    String scaling_governor = cpufreq_sys_dir
            + "scaling_governor";
    String scaling_available_freq = cpufreq_sys_dir
            + "scaling_available_frequencies";
    String scaling_available_governors = cpufreq_sys_dir
    ...
    String[] readAheadKb = {"64", "128", "256", "384",
    ...
    String[] mFragmentsArray = new String[]{
            ...
            "Settings"};
    int icons[] = new int[]{R.drawable.ic_action_meter,
